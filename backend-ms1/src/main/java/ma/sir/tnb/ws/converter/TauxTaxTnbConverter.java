...
public class TauxTaxTnbConverter extends AbstractConverter<TauxTaxTnb, TauxTaxTnbDto, TauxTaxTnbHistory> {
    ...
    public TauxTaxTnb toItem(TauxTaxTnbDto dto) {
        ...
        TauxTaxTnb item = new TauxTaxTnb();
            ...
            if(StringUtil.isNotEmpty(dto.getPrixMatreCarre()))
                item.setPrixMatreCarre(dto.getPrixMatreCarre());
            if(this.categorieTerrain && dto.getCategorieTerrain()!=null)
    ...
    public TauxTaxTnbDto toDto(TauxTaxTnb item) {
        if (item == null) {
            ...
            if(StringUtil.isNotEmpty(item.getPrixMatreCarre()))
                dto.setPrixMatreCarre(item.getPrixMatreCarre());
