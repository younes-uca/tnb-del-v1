...
@Component({
  selector: 'app-tax-tnb-create-admin',
  templateUrl: './tax-tnb-create-admin.component.html'
})
export class TaxTnbCreateAdminComponent extends AbstractCreateController<TaxTnbDto, TaxTnbCriteria, TaxTnbService>  implements OnInit {
    ...
    constructor( private taxTnbService: TaxTnbService , private terrainService: TerrainService, private redevableService: RedevableService, private tauxTaxTnbService: TauxTaxTnbService) {
        super(taxTnbService);
    }
