...
export class TaxTnbListAdminComponent extends AbstractListController<TaxTnbDto, TaxTnbCriteria, TaxTnbService>  implements OnInit {
    ...
    constructor(taxTnbService: TaxTnbService, private redevableService: RedevableService, private terrainService: TerrainService, private tauxTaxTnbService: TauxTaxTnbService) {
        super(taxTnbService);
    }
