...
@Component({
  selector: 'app-terrain-edit-admin',
  templateUrl: './terrain-edit-admin.component.html'
})
export class TerrainEditAdminComponent extends AbstractEditController<TerrainDto, TerrainCriteria, TerrainService>   implements OnInit {
    ...
    constructor( private terrainService: TerrainService , private categorieTerrainService: CategorieTerrainService, private redevableService: RedevableService) {
